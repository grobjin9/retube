...
import { roomShowUpAnimation } from '../../utils/animationSettings';
...
const Room = ({_id, name, description, favorite, deletable, tags, roomOnClick, tagOnClick, favoriteOnClick, deleteOnClick}) => {
  ...
  return (
    <ReactCSSTransitionGroup component="div" className={"rooms__room room"} {...roomShowUpAnimation} >
...
Room.propTypes = {
  ...
  favoriteOnClick: React.PropTypes.func.isRequired,
